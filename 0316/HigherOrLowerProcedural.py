...
# Card constants
SUIT_TUPLE = ('黑桃', '红心', '草花', '方块')
RANK_TUPLE = ('Ace', '2', '3', '4', '5', '6', '7',
              '8', '9', '10', 'Jack', 'Queen', 'King')

NCARDS = 8

# Pass in a deck and this function returns a random card from the deck（发牌）
...
# Pass in a deck and this function returns a shuffled copy of the deck（洗牌）
