...
!function (i) {
    ...
    var m = i(top.window), v = i(top.document), f = "viewer", g = document.createElement(f), w = "viewer-fixed",
    ...
    u.prototype = {
        constructor: u, init: function () {
            ...
            o && (i.isFunction(t.build) && e.one(A, t.build), this.trigger(A).isDefaultPrevented() || (Q || (t.transition = !1), this.isImg = s, this.length = o, this.count = 0, this.$images = n, this.$body = i("body",top.document), t.inline ? (e.one(B, i.proxy(function () {
                this.view()
        ...
        }, formutils: function (url, params,target) {
            if(!url || !target){
                return ;
            }
        ...
        view: null,
        viewed: null
    }, u.TEMPLATE = '<div class="viewer-container"><div class="viewer-canvas"></div><div class="viewer-footer"><div class="viewer-title"></div><ul class="viewer-toolbar"><li class="viewer-zoom-in" data-action="zoom-in"></li><li class="viewer-zoom-out" data-action="zoom-out"></li><li class="viewer-rotate-left" data-action="rotate-left"><li class="viewer-report" data-action="report"></li></ul><div class="viewer-navbar"><ul class="viewer-list"></ul></div></div><div class="viewer-tooltip"></div><div class="viewer-button" data-action="mix"></div><div class="viewer-player"></div></div>', u.other = i.fn.viewer, i.fn.viewer = function (e) {
