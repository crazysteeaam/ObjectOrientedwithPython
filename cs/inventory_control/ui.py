...
def prompt_for_new_sku_id():
    """ 提示用户输入新的产品sku_id并返回，或返回None """
    while True:
        sku_id = input("请输新的产品ID:")
...
def prompt_for_old_loc_id():
    """ 提示用户输入有效的货架位置loc_id并返回，或返回None """
    while True:
        loc_id = input("请输货架位置ID:")
        if loc_id == "": 
            return None
...
def prompt_for_sku_name():
    """ 提示用户输入产品名称sku_name并返回，或返回None """
    while True:
        sku_name = input("请输产品名称:")
        if sku_name == "": return None
        else: return sku_name

def prompt_for_loc_name():
    """ 提示用户输入货架位置名称loc_name并返回，或返回None """
    while True:
        loc_name = input("请输货架位置名称ID:")
