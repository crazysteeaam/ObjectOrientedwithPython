...
class UserWindow(wx.Dialog):
    def __init__(self, parent, title):
        ...
        self.listUser.InsertColumn(3, '电话号码', width=100)
        self.listUser.InsertColumn(4, '出生年月', width=100)
    ...
    def onUserList(self, e):
        ...
        self.inputTextBirthday.SetValue(self.listUser.GetItem(index, 4).GetText())
    ...
    def onInsert(self, e):
        ...
        if data.check_user_id(userid):
            ...
            return None
        # 插入记录
        data.insert_user(user_type, userid, username, gender, birthday, phone)
        # 初始化界面
        self.refresh_screen()
    ...
    def onUpdate(self, e):
        ...
        if len(username.strip()) == 0:
            ...
            return None
        # 更新记录
        data.update_user( username, gender, birthday, phone,userid)
        # 初始化界面
        self.refresh_screen()
